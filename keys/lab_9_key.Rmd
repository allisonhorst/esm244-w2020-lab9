...
# Get just the vector of plumage index
sal_nc <- salinity$sal

# Bootstrap (100 samples with replacement)
salboot_100 <- boot(sal_nc, 
                    statistic = mean_fun,
                    R = 100)

# Bootstrap (10000 samples with replacement)
...
# Question: do we all get the same thing? What would we have to do in order to all get the same thing? And would we *want* that? 
